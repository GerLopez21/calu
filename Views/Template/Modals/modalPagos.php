            ...
            <div class="tile-body">
              <form id="formTipopago" name="formTipopago">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="txtNombre" name="txtNombre" type="text" placeholder="Tipo de envío" required="">
                </div>
                <div class="form-group">
                  <label class="control-label">Descripción</label>
                  <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" type="textarea" placeholder="Descripción del envío" required=""></textarea>
                </div>
